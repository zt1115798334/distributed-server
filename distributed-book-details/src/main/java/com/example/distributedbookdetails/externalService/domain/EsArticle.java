...
public class EsArticle {
     ...
     * 主题id
     */
    private List<Long> thesaurusThemeIds;
    ...
    /**
     * 将文章标题中出现的特殊的字符替换掉  截取后
     */
    private String cleanTitleCut;
    ...
    public EsArticle(String id, Integer region, String carrier,
                     String siteName, LocalDateTime createTime, LocalDateTime gatherTime, LocalDate publishDate, LocalDateTime publishTime,
                     ...
                     List<String> entityArea, List<String> entityName, List<String> entityOrganization, String multilingualType) {
        this.id = id;
        this.region = region;
        ...
        this.title = title;
        this.titleCut = MStringUtils.interceptingReplacing(title, 40, "...");
        this.cleanTitle = cleanTitle;
        this.cleanTitleCut = MStringUtils.interceptingReplacing(cleanTitle, 40, "...");
        ...
        this.multilingualType = multilingualType;
    }
}
