package com.example.distributedbookdetails.externalService.custom;
...
public class SysConst {
    ...
    public static final long ES_CACHE_TIMEOUT = 1L;
    public static final TimeUnit ES_CACHE_UNIT = TimeUnit.SECONDS;
    ...
    public enum ArticleType {
        ...
        INSTANT_MESSAGING(2, "comment", "即时通讯"),
    ...
    public static class TemplateNumber {
        ...
        public enum MediaEdition {
            TYPE_0(0, "新闻态势", Collections.singletonList(Carrier.CARRIER_NEWS)),
            TYPE_1(1, "两微态势", Arrays.asList(Carrier.CARRIER_MICRO_BLOG, Carrier.CARRIER_WE_CHAT)),
            TYPE_2(2, "论坛态势", Collections.singletonList(Carrier.CARRIER_FORUM)),
            TYPE_3(3, "贴吧态势", Collections.singletonList(Carrier.CARRIER_POSTS_BAR)),
            TYPE_4(4, "纸媒态势", Collections.singletonList(Carrier.CARRIER_ELECTRONIC_NEWSPAPER)),
            TYPE_5(5, "其他态势", Arrays.asList(Carrier.CARRIER_APP, Carrier.CARRIER_INTER_LOCUTION,
                    Carrier.CARRIER_BLOG, Carrier.CARRIER_COMPREHENSIVE, Carrier.CARRIER_VIDEO, Carrier.CARRIER_SHORT_VIDEO)),
            TYPE_6(6, "外媒态势", Collections.EMPTY_LIST);
    ...
    public enum MenuApp {
        ...
        APP_OPINION_OA(24L, "opinionOA", "态势OA"),
        APP_INCIDENT(25L, "incident", "态势智库"),
        APP_TOPICAL(26L, "topical", "态势风向标"),
    ...
    public enum MenuType {
        ...
        MONITOR_TYPE(1, "monitorType", "态势监测"),
        ANALYSIS_TYPE(2, "analysisType", "态势分析"),
        WORK_TYPE(3, "workType", "办公辅助"),
        OTHER_TYPE(4, "otherType", "态势周边"),
    ...
    public enum BigScreenSet {
        ...
        BS_SPECIAL("专题检测版大屏", "bsSpecial", "", "1", "1", 1),
        BS_EVENT("突发态势事件指挥中心", "bsEvent", "", "1", "1", 2),
